...
if uploaded_file:
    ...
    menu = ["Accueil", "Wordcloud & Clustering", "Système de Recommandation", "NER", "Analyse de Sentiment", "Traitement du texte", "Prédiction manuelle", "WordCloud par Sentiment","NGram","Prediction avec LogReg","Prediction avec XGBoost","Prediction avec SVM"]
